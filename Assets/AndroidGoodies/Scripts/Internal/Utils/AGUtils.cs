namespace DeadMosquito.AndroidGoodies.Internal
{
	...
	public static class AGUtils
	{
		...
		public static AndroidIntent ActivityIntent => AndroidIntent.Wrap(Activity.CallAJO("getIntent"));

		public static AndroidJavaObject ExternalCacheDirectory => Activity.CallAJOSafe("getExternalCacheDir");

		public static AndroidJavaObject CacheDirectory => Activity.CallAJOSafe("getCacheDir");

		public static AndroidJavaObject CodeCacheDirectory => Activity.CallAJOSafe("getCodeCacheDir");

		public static AndroidJavaObject DataDir => Activity.CallAJOSafe("getDataDir");

		public static AndroidJavaObject ObbDir => Activity.CallAJOSafe("getObbDir");

		public static AndroidJavaObject ActivityDecorView => Window.Call<AndroidJavaObject>("getDecorView");

		public static AndroidJavaObject Window => Activity.Call<AndroidJavaObject>("getWindow");
		...
		{
			return C.UnityHelperUtilsClass.AJCCallStaticOnceAJO("classForName", className);
		}
		...
		public static AndroidJavaObject CurrentAppLaunchIntent => GetLaunchIntent(AGDeviceInfo.GetApplicationPackage());

		public static AndroidJavaObject NotificationIntermediateActivityIntent => new AndroidIntent(ClassForName(C.GoodiesNotificationsIntermediateActivity)).AJO;
		...
		{
			var encoded = tex2D.Encode(format);
		...
		public static int RandomId() => UnityEngine.Random.Range(int.MinValue, int.MaxValue);
	}
}
