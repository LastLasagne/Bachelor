	...
	public class AGExifInterface
	{
		...
		public override string ToString()
		{
			return string.Format(
				"Altitude: {0}, Thumbnail: {1}, ThumbnailBytes: {2}, ThumbnailRange: {3}, HasThumbnail: {4}, "
		...
		/// </summary>
		[PublicAPI]
		public void SaveAttributes() => ajo.Call("saveAttributes");

		void SetAttribute(string tagName, string propertyValue) => ajo.Call("setAttribute", tagName, propertyValue);

		string GetStringAttribute(string tagName) => ajo.CallStr("getAttribute", tagName);

		double GetDoubleAttribute(string tagName) => ajo.Call<double>("getAttributeDouble", tagName, double.MinValue);

		int GetIntAttribute(string tagName) => ajo.CallInt("getAttributeInt", tagName, int.MinValue);
	}
}
