...
namespace DeadMosquito.AndroidGoodies
{
	...
	public static class AGGallery
	{
		...
		/// <param name="shouldGenerateThumbnails">Whether thumbnail images will be generated. Used to show small previews of image.</param>
		[PublicAPI]
		public static void PickMultipleImagesFromGallery([NotNull] Action<List<ImagePickResult>> onSuccess, Action<string> onError, ImageResultSize maxSize = ImageResultSize.Original, bool shouldGenerateThumbnails = true)
		{
			if (AGUtils.IsNotAndroid())
			{
				return;
