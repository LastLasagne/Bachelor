...
namespace DeadMosquito.AndroidGoodies
{
	...
	public static class AGApps
	{
		...
		public static void WatchYoutubeVideo(string id)
		{
			...
			AGUtils.StartActivity(
				intent.AJO,
				() =>
				{
					var fallbackIntent = new AndroidIntent(AndroidIntent.ActionView, AndroidUri.Parse("http://www.youtube.com/watch?v=" + id));
		...
		public static void UninstallApp(string package)
		{
			...
			try
			{
				var uri = AndroidUri.Parse($"package:{package}");
