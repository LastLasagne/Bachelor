namespace DeadMosquito.AndroidGoodies
{
	...
	public static class AGBattery
	{
		...
		static AndroidJavaObject BatteryChangeIntentFilter => new AndroidJavaObject("android.content.IntentFilter", AndroidIntent.ActionBatteryChanged);

		static AndroidJavaObject BatteryChangeIntentReceiver => AGUtils.Activity.CallAJO("registerReceiver", null, BatteryChangeIntentFilter);
