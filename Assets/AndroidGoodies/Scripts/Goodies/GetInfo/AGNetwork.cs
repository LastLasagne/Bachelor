...
namespace DeadMosquito.AndroidGoodies
{
	...
	public static class AGNetwork
	{
		...
		public class WifiConfiguration
		{
			...
			public string BSSID
			{
				get => ajo.Get<string>("BSSID");
				set => ajo.Set("BSSID", value);
			}
			...
			public string FQDN
			{
				get => ajo.Get<string>("FQDN");
				set => ajo.Set("FQDN", value);
			}
			...
			public string SSID
			{
				get => ajo.Get<string>("SSID");
				set => ajo.Set("SSID", value);
			}
			...
			{
				get => ajo.Get<int>("networkId");
				set => ajo.Set("networkId", value);
			}
			...
			public int Priority
			{
				get => ajo.Get<int>("priority");
				set => ajo.Set("priority", value);
			}

			[PublicAPI]
			public override string ToString()
			{
				return $"Network ID: {NetworkId}, SSID: {SSID}, FQDN: {FQDN}, BSSID: {BSSID}.\n";
			}
		}
