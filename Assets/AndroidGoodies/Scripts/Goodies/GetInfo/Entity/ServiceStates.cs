namespace DeadMosquito.AndroidGoodies
{
	...
	public class ServiceStates
	{
		...
		public bool IsManualSelection
		{
			...
			set => ajo.Call("setIsManualSelection", value);
		}
		...
		public string OperatorAlphaLong
		{
			...
			set => ajo.Call("setOperatorName", value, OperatorAlphaShort, OperatorNumeric);
		}
		...
		public string OperatorAlphaShort
		{
			...
			set => ajo.Call("setOperatorName", OperatorAlphaLong, value, OperatorNumeric);
		}
		...
		public string OperatorNumeric
		{
			...
			set => ajo.Call("setOperatorName", OperatorAlphaLong, OperatorAlphaShort, value);
		}
		...
		public States State
		{
			...
			set => ajo.Call("setState", (int)value);
		}
	}
}
