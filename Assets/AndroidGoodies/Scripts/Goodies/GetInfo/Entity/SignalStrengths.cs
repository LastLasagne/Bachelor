namespace DeadMosquito.AndroidGoodies
{
	...
	public class SignalStrengths
	{
		...
		{
			return $"CDMA RSSI value is {cdmaDbm} dBm, CDMA Ec/Io value is {cdmaEcio} dB*10, EVDO RSSI value is {evdoDbm} dBm, EVDO Ec/Io value is {evdoEcio} dB*10, signal to noise ratio is {evdoSnr}, GSM bit error rate is {gsmBitErrorRate}, GSM Signal Strength is {gsmSignalStrength}, signal level is {level}, is GSM - {isGsm}.";
		}
	}
}
