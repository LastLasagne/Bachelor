namespace DeadMosquito.AndroidGoodies
{
	...
	public class AGAlertDialog
	{
		...
		AGAlertDialog(Builder builder)
		{
			...
			{
				javaBuilder.CallAJO("setSingleChoiceItems", builder._singleChoiceItems, builder._singleChoiceCheckedItem, new DialogOnClickListenerProxy(builder._singleChoiceItemClickCallback));
			}

			if (builder._areMultiChoiceItemsSet)
			{
				javaBuilder.CallAJO("setMultiChoiceItems", builder._multiChoiceItems, builder._multiChoiceCheckedItems, new DialogOnMultiChoiceClickListenerProxy(builder._multiChoiceItemClickCallback));
			}
		...
		static AndroidJavaObject CreateDialogBuilder(AGDialogTheme theme)
		{
			...
			return AndroidDialogUtils.IsDefault(themeResource) ? new AndroidJavaObject(AlertDialogBuilderClass, AGUtils.Activity) : new AndroidJavaObject(AlertDialogBuilderClass, AGUtils.Activity, themeResource);
		}
		...
		void Show() => AndroidDialogUtils.ShowWithImmersiveModeWorkaround(_dialog);
		...
		public static void ShowMessageDialog(string title, string message, string positiveButtonText, Action onPositiveButtonClick, Action onDismiss = null, AGDialogTheme theme = AGDialogTheme.Default)
		{
			...
			{
				throw new ArgumentNullException(nameof(onPositiveButtonClick), "Button callback cannot be null");
			}
		...
		public static void ShowMessageDialog(string title, string message, string positiveButtonText, Action onPositiveButtonClick, string negativeButtonText, Action onNegativeButtonClick, Action onDismiss = null, AGDialogTheme theme = AGDialogTheme.Default)
		{
			...
			{
				throw new ArgumentNullException(nameof(onNegativeButtonClick), "Button callback cannot be null");
			}
		...
		)
		{
			...
			{
				throw new ArgumentNullException(nameof(onNeutralButtonClick), "Button callback cannot be null");
			}
		...
		static Builder CreateMessageDialogBuilder(string title, string message, string positiveButtonText, Action onPositiveButtonClick, Action onDismiss)
		{
		...
		public static void ShowSingleItemChoiceDialog(string title, string[] items, int checkedItem, Action<int> onItemClicked, string positiveButtonText, Action onPositiveButtonClick, AGDialogTheme theme = AGDialogTheme.Default)
		{
			...
			if (items == null)
			{
				throw new ArgumentNullException(nameof(items), "Items can't be null");
			}

			if (onItemClicked == null)
			{
				throw new ArgumentNullException(nameof(onItemClicked), "Item click callback cannot be null");
			}
		...
		public static void ShowMultiItemChoiceDialog(string title, string[] items, bool[] checkedItems, Action<int, bool> onItemClicked, string positiveButtonText, Action onPositiveButtonClick, AGDialogTheme theme = AGDialogTheme.Default)
		{
			...
			{
				throw new ArgumentNullException(nameof(checkedItems), "Checked items can't be null");
			}

			if (onItemClicked == null)
			{
				throw new ArgumentNullException(nameof(onItemClicked), "Item click callback can't be null");
			}

			if (onPositiveButtonClick == null)
			{
				throw new ArgumentNullException(nameof(onPositiveButtonClick), "Button click callback can;t be null");
			}
