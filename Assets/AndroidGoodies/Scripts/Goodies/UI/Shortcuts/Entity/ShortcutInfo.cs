	...
	public class ShortcutInfo
	{
		...
		public class Builder
		{
			...
			public Builder(string shortcutId)
			{
				...
				{
					Debug.LogError("This class should be used only on Android with API level 25 or higher, errors ahead");
					return;
				}
			...
			{
				var iconAjo = C.AndroidGraphicsDrawableIcon.AJCCallStaticOnceAJO("createWithBitmap", AGUtils.Texture2DToAndroidBitmap(tex));
		...
		/// </summary>
		[PublicAPI]
		public bool IsDynamic => ajo.CallBool("isDynamic");
		...
		{
			return $"DisabledMessage: {DisabledMessage}, DisabledReason: {DisabledReason}, Id: {Id}, LastChangedTimestamp: {LastChangedTimestamp}, LongLabel: {LongLabel}, Package: {Package}, Rank: {Rank}, ShortLabel: {ShortLabel}, HasKeyFieldsOnly: {HasKeyFieldsOnly}, IsDeclaredInManifest: {IsDeclaredInManifest}, IsDynamic: {IsDynamic}, IsEnabled: {IsEnabled}, IsImmutable: {IsImmutable}, IsPinned: {IsPinned}";
		}
	}
}
