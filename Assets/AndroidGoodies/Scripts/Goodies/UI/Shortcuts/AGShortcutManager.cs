namespace DeadMosquito.AndroidGoodies.Internal
{
	...
	public static class AGShortcutManager
	{
		...
		public static void RequestPinShortcut(ShortcutInfo shortcut)
		{
			...
			var intent = AndroidIntent.Wrap(AGSystemService.ShortcutService.CallAJO("createShortcutResultIntent", shortcut.ajo));
		...
		/// </summary>
		[PublicAPI]
		public static void DisableShortcuts(List<string> shortcutIds, [CanBeNull] string disabledMessage)
		{
			if (!AreShortCutsSupported)
			{
				return;
		...
		/// </summary>
		[PublicAPI]
		public static string GetShortcutParameter([NotNull] string key)
		{
			if (key == null)
			{
		...
		public static bool AreShortCutsSupported => !AGUtils.IsNotAndroid() && Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.N_MR1);
	}
}
