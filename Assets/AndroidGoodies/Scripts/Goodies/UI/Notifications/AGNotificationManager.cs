namespace DeadMosquito.AndroidGoodies
{
	...
	{
		public static Action<int> _onNotificationReceived;
		...
		public static List<NotificationChannelGroup> NotificationChannelGroups
		{
			get
			{
				...
				var ajos = AGSystemService.NotificationService.CallAJO("getNotificationChannelGroups").FromJavaList<AndroidJavaObject>();
				foreach (var ajo in ajos)
				{
		...
		public static InterruptionFilter CurrentInterruptionFilter
		{
			get
			{
				...
				{
					return (InterruptionFilter)AGSystemService.NotificationService.CallInt("getCurrentInterruptionFilter");
				}
		...
		/// </summary>
		[AndroidApi(AGDeviceInfo.VersionCodes.BASE)]
		public static bool AreNotificationChannelsSupported => Check.IsSdkGreaterOrEqual(AGDeviceInfo.VersionCodes.O);

		internal static bool HasNoNewNotificationsApi => !AreNotificationChannelsSupported;
		...
		public static NotificationChannel GetNotificationChannel([NotNull] string channelId)
		{
			...
			return new NotificationChannel(AGSystemService.NotificationService.CallAJO("getNotificationChannel", channelId));
		}
		...
		public static NotificationChannelGroup GetNotificationChannelGroup(string channelGroupId)
		{
			...
			{
				return new NotificationChannelGroup(AGSystemService.NotificationService.CallAJO("getNotificationChannelGroup", channelGroupId));
			}
		...
		/// <summary>
		/// Sets a listener that is invoked when a scheduled notification arrives. ONLY WORKS WHEN THE APP IS IN FOREGROUND!
		/// </summary>
		/// <param name="onNotificationReceived">listener</param>
		public static void SetOnScheduledNotificationReceivedListener([NotNull] Action<int> onNotificationReceived)
		{
		...
		public class Policy
		{
			...
			/// </param>
			[PublicAPI]
			public Policy(PriorityCategory priorityCategories, PrioritySenders priorityCallSenders, PrioritySenders priorityMessageSenders, SuppressedEffect suppressedVisualEffects)
			{
				AJO = new AndroidJavaObject(C.AndroidAppNotificationManagerPolicy, (int)priorityCategories, (int)priorityCallSenders, (int)priorityMessageSenders, (int)suppressedVisualEffects);
			}
			...
			/// </param>
			[PublicAPI]
			public Policy(PriorityCategory priorityCategories, PrioritySenders priorityCallSenders, PrioritySenders priorityMessageSenders)
			{
				AJO = new AndroidJavaObject(C.AndroidAppNotificationManagerPolicy, (int)priorityCategories, (int)priorityCallSenders, (int)priorityMessageSenders);
			}
