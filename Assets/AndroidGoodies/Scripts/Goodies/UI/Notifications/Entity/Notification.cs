		...
		public class Action
		{
			...
			public class Builder
			{
				...
				public Builder(int icon, string title, AndroidIntent intent)
				{
					...
					AJO = new AndroidJavaObject(C.AndroidAppNotificationCompatActionBuilder, icon, title, pendingIntent);
				}
		...
		public class MessagingStyle
		{
			...
			public class Message
			{
				...
				public Message(string text, long time, string sender = null)
				{
					...
					AJO = new AndroidJavaObject(C.AndroidAppNotificationCompatMessagingStyleMessage, text, time, sender);
				}
