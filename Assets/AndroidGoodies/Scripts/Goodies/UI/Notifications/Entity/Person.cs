namespace DeadMosquito.AndroidGoodies
{
	...
	public class Person
	{
		...
		/// </summary>
		[PublicAPI]
		public string Key => AJO.CallStr("getKey");

		/// <summary>
		///     The name provided for this person or null if no name was provided.
		/// </summary>
		[PublicAPI]
		public string Name => AJO.CallStr("getName");

		/// <summary>
		///     The uri provided for this person or null if no Uri was provided.
		/// </summary>
		[PublicAPI]
		public string Uri => AJO.CallStr("getUri");

		/// <summary>
		///     Whether this Person is a machine.
		/// </summary>
		[PublicAPI]
		public bool IsBot => AJO.CallBool("isBot");

		/// <summary>
		///     Whether this Person is important.
		/// </summary>
		[PublicAPI]
		public bool IsImportant => AJO.CallBool("isImportant");

		public static bool IsNotSupported => AGUtils.IsNotAndroid() && Check.IsSdkSmallerThan(AGDeviceInfo.VersionCodes.P);

		/// <summary>
		///     Creates and returns a new Person.Builder initialized with this Person's data.
		/// </summary>
		[PublicAPI]
		public Builder ToBuilder() => IsNotSupported ? null : new Builder(AJO.CallAJO("toBuilder"));
		...
		public class Builder
		{
			...
			/// </summary>
			[PublicAPI]
			public Person Build() => new Person(_ajo.CallAJO("build"));
		}
	}
}
