namespace DeadMosquito.AndroidGoodies
{
	...
	public class NotificationChannel
	{
		...
		/// </param>
		[PublicAPI]
		public NotificationChannel(string id, string name, AGNotificationManager.Importance importance = AGNotificationManager.Importance.Default)
		{
			if (ApiCheck)
			{
				return;
		...
		static bool ApiCheck => AGUtils.IsNotAndroid() || AGNotificationManager.HasNoNewNotificationsApi;
		...
		public void SetSound([NotNull] string soundFilePath, AudioAttributes audioAttributes)
		{
			...
			AJO.Call("setSound", AndroidUri.FromFile(soundFilePath), audioAttributes == null ? null : audioAttributes.AJO);
		}
		...
		/// </summary>
		[PublicAPI]
		public void SetSoundFromRawResource([NotNull] string soundFilename, AudioAttributes audioAttributes)
		{
			...
			AJO.Call("setSound", AndroidUri.Parse(path), audioAttributes == null ? null : audioAttributes.AJO);
		}
