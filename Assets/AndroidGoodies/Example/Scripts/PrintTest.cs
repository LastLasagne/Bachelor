...
#pragma warning restore 0649
	...
	public void OnPrintImage()
	{
		...
		{
			AGPrintHelper.PrintImage(
				image,
				PrintJobName,
				() =>
				{
					AGUIMisc.ShowToast("Printing success");
				},
				AGPrintHelper.ColorModes.Monochrome,
				AGPrintHelper.Orientations.Landscape,
				AGPrintHelper.ScaleModes.Fill
			);
		}
		else
		{
