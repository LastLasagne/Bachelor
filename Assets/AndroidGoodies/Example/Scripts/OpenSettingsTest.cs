namespace AndroidGoodiesExamples
{
	...
	public class OpenSettingsTest : MonoBehaviour
	{
		...
		{
			AGSettings.OpenModifySystemSettingsActivity(() => AGUIMisc.ShowToast("Could Not find Modify System Settings Activity"));
		}

		public void CheckIfAppCanWriteSystemSettings()
		{
			var canWriteSystemSettings = AGSettings.CanWriteSystemSettings();
