namespace AndroidGoodiesExamples
{
	...
	public class AlarmClockTest : MonoBehaviour
	{
		...
		{
			var weekdays = new[] { AGAlarmClock.AlarmDays.Monday, AGAlarmClock.AlarmDays.Tuesday, AGAlarmClock.AlarmDays.Wednesday, AGAlarmClock.AlarmDays.Thursday, AGAlarmClock.AlarmDays.Friday, };
