namespace AndroidGoodiesExamples
{
	...
	public class GPSTest : MonoBehaviour
	{
		...
		void TestDistanceBetween()
		{
			...
			AGGPS.DistanceBetween(AmsterdamLatitude, AmsterdamLongitude, BrusselsLatitude, BrusselsLongitude, results);
		...
		{
			AGPermissions.ExecuteIfHasPermission(AGPermissions.ACCESS_FINE_LOCATION, StartLocationTacking, () => ExampleUtil.ShowPermissionErrorToast(AGPermissions.ACCESS_FINE_LOCATION));
		}
