...
#pragma warning restore 0649
		...
		{
			return CreateBasicShortcut().SetShortLabel("Documentation").SetLongLabel("Read the documentation").SetOpenUrlIntent("https://github.com/NinevaStudios/android-goodies-docs-PRO").Build();
		}
		...
		public void CreateThisAppShortcut()
		{
			...
			var shortcut = CreateBasicShortcut().SetShortLabel("Open App").SetOpenThisAppIntent(customData).Build();
		...
		{
			var builder = new ShortcutInfo.Builder(ShortcutId).SetIcon(_icon).SetRank(1).SetLongLabel("Long Label");
			return builder;
		}
