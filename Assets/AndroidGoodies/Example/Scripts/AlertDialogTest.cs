namespace AndroidGoodiesExamples
{
	...
	public class AlertDialogTest : MonoBehaviour
	{
		...
		{
			AGAlertDialog.ShowMessageDialog("Single Button", "This dialog has only positive button", "Ok", () => AGUIMisc.ShowToast("Positive button Click"), () => AGUIMisc.ShowToast("Dismissed"), AGDialogTheme.Dark);
		}

		[UsedImplicitly]
		public void OnMessageTwoButtonDialog()
		{
			AGAlertDialog.ShowMessageDialog("Two Buttons", "This dialog has positive and negative button", "Ok", () => AGUIMisc.ShowToast("Positive button Click"), "No!", () => AGUIMisc.ShowToast("Negative button Click"), () => AGUIMisc.ShowToast("Dismissed"), AGDialogTheme.Dark);
		}
		...
		public void OnMessageThreeButtonDialog()
		{
			AGAlertDialog.ShowMessageDialog(
				...
				"Ok",
				() => AGUIMisc.ShowToast("Positive button Click"),
				"No!",
				() => AGUIMisc.ShowToast("Negative button Click"),
				"Maybe!",
				() => AGUIMisc.ShowToast("Neutral button Click"),
				() => AGUIMisc.ShowToast("Dismissed"),
				AGDialogTheme.Light
			);
		}
		...
		{
			AGAlertDialog.ShowChooserDialog("Choose color", Colors, colorIndex => AGUIMisc.ShowToast(Colors[colorIndex] + " selected"), AGDialogTheme.Light);
		}
		...
		public void OnShowDialogSingleChooseItem()
		{
			...
			AGAlertDialog.ShowSingleItemChoiceDialog("Choose color", Colors, defaultSelectedItemIndex, colorIndex => AGUIMisc.ShowToast(Colors[colorIndex] + " selected"), "OK", () => AGUIMisc.ShowToast("OK!"), AGDialogTheme.Dark);
		}
		...
		public void OnShowDialogMultiChooseItem()
		{
			...
			AGAlertDialog.ShowMultiItemChoiceDialog("Choose color", Colors, initiallyCheckedItems, (colorIndex, isChecked) => AGUIMisc.ShowToast(Colors[colorIndex] + " selected? " + isChecked), "OK", () => AGUIMisc.ShowToast("OK!"), AGDialogTheme.Light);
		}
		...
		IEnumerator ShowHorizontalForDuration()
		{
			...
			while (currentProgress < progressDuration)
			{
				...
				var progress = Mathf.CeilToInt((currentProgress / progressDuration) * dialogMaxProgress);
